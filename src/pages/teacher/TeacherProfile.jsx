...
import { User, Mail, Phone, MapPin, Calendar, Award, BookOpen, Users, Star } from 'lucide-react';
    ...
    <div className="space-y-8">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-white via-gray-50 to-blue-50 p-8 shadow-xl">
        ...
        <div className="relative z-10 text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-800 mb-2">Giáo viên KoreanHwa</h2>
          <p className="text-gray-600 mb-6">Chuyên gia giảng dạy tiếng Hàn</p>
