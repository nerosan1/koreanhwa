...
const ForumCreate = () => {
  ...
  const handleSubmit = (publishNow = false) => {
    ...
    alert(publishNow ? 'Bài viết đã được đăng thành công!' : 'Bài viết đã được lưu nháp!');
    navigate('/admin/content'); // Navigate back to content management
  };
          ...
          <div key={block.id}>
            ...
            {block.type === 'link' && block.url && (
              <div className="border border-gray-200 rounded-lg p-4 hover:bg-gray-50">
                <a href={block.url} className="text-blue-600 hover:underline font-medium">
              ...
              <div className="space-y-4">
                {post.content.length === 0 ? (
                  <div className="text-center py-12 text-gray-500">
                    ...
                    <p>Chưa có nội dung nào. Thêm khối nội dung để bắt đầu viết bài.</p>
                  </div>
                ) : (
