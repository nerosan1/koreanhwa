...
const ExamUpdate = () => {
  ...
  const mockExam = {
    ...
    endDate: '2024-02-20T18:00',
    status: 'active',
    entryFee: 0,
    totalPrize: 5000000,
    instructions: 'Đọc kỹ câu hỏi trước khi trả lời. Mỗi câu chỉ có một đáp án đúng.',
    rules: [
      'Không được sử dụng tài liệu tham khảo',
      'Không được trao đổi với thí sinh khác',
      'Nộp bài trước khi hết thời gian',
      'Tuân thủ quy định của phòng thi'
    ],
    image: '/src/assets/phatam.jpg',
    thumbnail: '/src/assets/phatam.jpg',
    ...
    questions: [
      {
        id: 1,
        question: 'Từ "안녕하세요" có nghĩa là gì?',
        type: 'multiple-choice',
      ...
      {
        id: 2,
        question: 'Trong tiếng Hàn, "가족" có nghĩa là "gia đình"',
        type: 'true-false',
        options: ['Đúng', 'Sai'],
        correctAnswer: 0,
        points: 1,
        explanation: '가족 thực sự có nghĩa là gia đình trong tiếng Hàn'
      },
      {
        id: 3,
        question: 'Hãy chọn từ đúng để điền vào chỗ trống: 저는 한국어를 ___ 좋아합니다.',
        type: 'multiple-choice',
        options: ['매우', '정말', '너무', 'Tất cả đều đúng'],
        correctAnswer: 3,
        points: 3,
        explanation: 'Tất cả các từ đều có thể dùng để diễn tả mức độ thích'
      }
    ]
  };
    ...
    const loadExam = async () => {
      ...
      try {
        ...
        setFormData({
          ...
          entryFee: mockExam.entryFee,
          totalPrize: mockExam.totalPrize,
          instructions: mockExam.instructions,
          rules: mockExam.rules,
          image: mockExam.image,
          thumbnail: mockExam.thumbnail,
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Chỉnh sửa kỳ thi</h1>
              <p className="text-gray-600">Cập nhật thông tin kỳ thi</p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-6">
              ...
              {/* Exam Stats */}
              <Card className="p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Thống kê hiện tại</h3>
                <div className="space-y-3">
                  <div className="flex justify-between">
                    <span className="text-sm text-gray-500">Đăng ký:</span>
                    <span className="text-sm font-medium text-gray-900">{mockExam.registeredStudents}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm text-gray-500">Hoàn thành:</span>
                    <span className="text-sm font-medium text-gray-900">{mockExam.completedStudents}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm text-gray-500">Điểm TB:</span>
                    <span className="text-sm font-medium text-gray-900">{mockExam.averageScore}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm text-gray-500">Tạo bởi:</span>
                    <span className="text-sm font-medium text-gray-900">{mockExam.createdBy}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm text-gray-500">Ngày tạo:</span>
                    <span className="text-sm font-medium text-gray-900">{mockExam.createdAt}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-sm text-gray-500">Cập nhật cuối:</span>
                    <span className="text-sm font-medium text-gray-900">{mockExam.lastUpdated}</span>
                  </div>
                </div>
              </Card>
              ...
              {/* Quick Stats */}
              <Card className="p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Cấu hình mới</h3>
                <div className="space-y-3">
                  <div className="flex justify-between">
              ...
              <Card className="p-6">
                ...
                <div className="space-y-3">
                  ...
                  <Button
                    ...
                    variant="outline"
                    className="w-full"
                    onClick={() => navigate(`/admin/exams/${id}/analytics`)}
                  >
