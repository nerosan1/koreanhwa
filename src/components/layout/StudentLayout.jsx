  ...
  const navigation = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          icon: TrendingUp,
          description: 'Hành trình học tập'
        },
        {
          name: 'Bài học',
          href: '/student/lessons',
          icon: BookOpen,
          description: 'Học bài học theo cấp độ'
        },
        {
          name: 'Luyện đề TOPIK',
          href: '/student/topik',
          icon: GraduationCap,
          description: 'Luyện thi TOPIK'
        },
        {
          name: 'Từ vựng',
          href: '/student/vocabulary',
          icon: BookMarked,
          description: 'Quản lý từ vựng cá nhân'
        }
      ]
    },
    {
      ...
      items: [
        {
          ...
          icon: Trophy,
          description: 'Tham gia cuộc thi học viên'
        }
      ]
    },
    {
